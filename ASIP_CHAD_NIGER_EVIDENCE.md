...
- 部署：gh-pages commit `4f885db`，北京时间 2026-07-29 04:45
- main 提交：`33c8734`（含日报修复与证据回填）、`6c883b5`、`c01ca2c`、`cbe1f74`
- 站点：https://kenan032005.github.io/asip-site/
- 验证方式：脚本请求 github.io 页面 + raw.githubusercontent.com/gh-pages 数据，10 项检查全部通过：

- [x] 首页正常加载，无整页报错（HTTP 200，标题存在）
- [x] 最新事件列表显示本次新采集事件（乍得霍乱 DREF + NGO 应对，均 public_health / official_unverified）
- [x] 乍得国家页事件均属乍得（抽查）
- [x] 尼日尔国家页无尼日利亚事件（正则抽查 title_original，0 命中）
- [x] 无体育/农业/宣传类无关信息（engrais/football 等 0 命中；化肥宣传/银行会见/巡游仪式 3 条旧误报已隔离）
- [x] 事件类型无默认 armed_conflict 堆积（乍得/尼日尔 0 条武装冲突误标）
- [x] 日报窗口显示北京时间 22:00→22:00（chad/2026-07-28：07-27 22:00 → 07-28 22:00）
- [x] 日报领域文案为中文（"公共卫生、灾害与基础设施"）
- [x] 每条事件含来源与原文链接
