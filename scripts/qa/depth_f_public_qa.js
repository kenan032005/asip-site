#!/usr/bin/env node
/* DEPTH F public QA (github.io): 13 entities + 18 relations + 3 countries +
   indexes across 1920/1366/768/390 with CDN cache convergence retries. Writes
   qa-artifacts-depth-f/public-browser-qa.json */
const http = require("http");
const fs = require("fs");
const path = require("path");
const WebSocket = require("ws");
const PUBLIC = process.env.PUBLIC_BASE || "https://kenan032005.github.io/asip-site/intelligence/africa";
const CDP_PORT = Number(process.env.CDP_PORT || 9243);
const OUT = path.join(__dirname, "..", "..", "qa-artifacts-depth-f", "public-browser-qa.json");
...
async function main() {
  ...
  const report = { artifact: "DEPTHF_PUBLIC_BROWSER_QA", pages, totals: { pages: pages.length } };
