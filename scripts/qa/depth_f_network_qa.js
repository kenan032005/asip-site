...
const OUT = path.join(__dirname, "..", "..", "qa-artifacts-depth-f", "network-density-qa.json");

const FOCI = ["actor-sspdf", "actor-splm-io", "actor-nas", "actor-is-mozambique", "actor-fadm", "actor-rdf-mozambique", "actor-tanzania-tpdf", "actor-lna", "actor-gnu-forces", "actor-isis-libya"];
