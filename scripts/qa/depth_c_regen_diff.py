#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Depth C regeneration diff. Snapshot data -> run build generator on a copy? No:
...
deletions / count changes) by snapshotting data, re-running depth_c_import.py,
...
subprocess.run([sys.executable, str(ROOT / "scripts" / "gen" / "depth_c_import.py"), str(PACK)],
