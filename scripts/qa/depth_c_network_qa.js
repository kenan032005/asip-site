...
const OUT = path.join(__dirname, "..", "..", "qa-artifacts-depth-c", "network-density-qa.json");

const FOCI = ["actor-dan-na-ambassagou", "actor-dozos-of-macina", "actor-dana-atem", "actor-katiba-serma", "person-jafar-dicko", "person-ousmane-dicko", "person-abou-ghosmane", "person-youssouf-toloba"];
