...
deletions / count changes) by snapshotting data, re-running depth_b_import.py,
...
subprocess.run([sys.executable, str(ROOT / "scripts" / "gen" / "depth_b_import.py"), str(PACK)],
