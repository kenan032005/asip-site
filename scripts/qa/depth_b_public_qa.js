#!/usr/bin/env node
/* DEPTH B public QA (github.io): 8 priority entities + 11 priority relations +
   ...
   fresh bundle. Writes qa-artifacts-depth-b/public-browser-qa.json */
const http = require("http");
const fs = require("fs");
const path = require("path");
const WebSocket = require("ws");
const PUBLIC = process.env.PUBLIC_BASE || "https://kenan032005.github.io/asip-site/intelligence/africa";
const CDP_PORT = Number(process.env.CDP_PORT || 9235);
const OUT = path.join(__dirname, "..", "..", "qa-artifacts-depth-b", "public-browser-qa.json");
