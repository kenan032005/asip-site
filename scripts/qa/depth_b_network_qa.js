#!/usr/bin/env node
/* DEPTH B network density QA on priority foci (JAS, ISWAP, MNJTF, Nigeria Army,
...
const OUT = path.join(__dirname, "..", "..", "qa-artifacts-depth-b", "network-density-qa.json");

const FOCI = ["actor-jas", "actor-iswap", "actor-mnjtf", "actor-nigeria-army", "actor-chad-army", "actor-cameroon-army", "actor-lakurawa", "actor-ansaru"];
