#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""DEPTH F source probe: check existing sources for matches against the 25 packet candidates."""
import json, re
from pathlib import Path

DATA = Path("C:/Users/kenan/WorkBuddy/clean/asip-intelligence-depth-f/data/intelligence/africa")
PACK = Path("C:/Users/kenan/Downloads/ASIP_Depth_F_Residual_Core_Content_Pack.json")
