...
deletions / count changes) by snapshotting data, re-running depth_f_import.py,
...
subprocess.run([sys.executable, str(ROOT / "scripts" / "gen" / "depth_f_import.py"), str(PACK)],
