#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""ASIP I3-D2 full regression: all intelligence python tests, node checks, build,
...
expected = {"country_count": 13, "non_country_entity_count": 72, "relationship_count": 150, "relation_profile_count": 50, "relation_timeline_count": 50, "route_count": 249}
...
route_missing = []
for rt in ["entity/jafar-dicko/", "entity/katiba-hanifa/", "entity/dana-atem/", "entity/dozos-of-macina/", "relation/d2-jnim-nigeria-emerging/", "relation/d2-dana-dan-na-split/", "relation/jnim-is-sahel-conflict/"]:
    if not (dist / rt / "index.html").exists():
        route_missing.append(rt)
        fail_total += 1

report = {
    "artifact": "I3D2_FULL_REGRESSION",
