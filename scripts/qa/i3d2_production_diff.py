#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""I3-D2 production diff: dist candidate vs published gh-pages tree.
Whitelist: intelligence/africa/** + assets/js/intelligence/africa.js (+ css if changed).
