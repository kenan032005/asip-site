#!/usr/bin/env node
/* DEPTH D candidate browser QA: 6 priority entities + 8 priority relations,
   ...
   Writes qa-artifacts-depth-d/candidate-browser-qa.json */
...
const OUT = path.join(__dirname, "..", "..", "qa-artifacts-depth-d", "candidate-browser-qa.json");
...
async function main() {
  ...
  const report = { artifact: "DEPTHD_CANDIDATE_BROWSER_QA", pages, totals: { pages: pages.length } };
