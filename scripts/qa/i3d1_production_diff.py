#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""I3-D1 production diff: dist candidate vs published gh-pages tree.
Whitelist: intelligence/africa/** (content update), assets/js/intelligence/africa.js (frontend fix),
assets/js/common.js (unchanged, still allowed). Main-site build-meta diffs are expected."""
