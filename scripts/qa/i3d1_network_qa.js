...
const OUT = path.join(__dirname, "..", "..", "qa-artifacts-i3d1", "network-density-qa.json");
const FOCI = ["actor-jnim", "actor-fla", "actor-africa-corps", "actor-fu-aes", "actor-lakurawa", "actor-ansaru"];
