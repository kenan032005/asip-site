#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Post-Expansion Global Audit P1 — full regression runner (discovers ALL test_*.py + EXTRA)."""
import glob
import io
import json
import os
...
QA = os.path.join(ROOT, "qa-artifacts-post-consolidation-global-audit-p2")
...
def main():
    ...
    payload = {
        "artifact": "POST_CONSOLIDATION_GLOBAL_AUDIT_P2_FULL_REGRESSION",
