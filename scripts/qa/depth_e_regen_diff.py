...
deletions / count changes) by snapshotting data, re-running depth_e_import.py,
...
subprocess.run([sys.executable, str(ROOT / "scripts" / "gen" / "depth_e_import.py"), str(PACK)],
