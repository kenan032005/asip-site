#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""DEPTH D source probe: check existing sources for matches against the 15 packet candidates."""
import json, re
from pathlib import Path

DATA = Path("C:/Users/kenan/WorkBuddy/clean/asip-intelligence-depth-d/data/intelligence/africa")
PACK = Path("C:/Users/kenan/Downloads/ASIP_Depth_D_Sudan_Content_Pack.json")
