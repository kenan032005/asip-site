#!/usr/bin/env node
/* DEPTH C candidate browser QA: 8 priority entities + 11 priority relations,
   ...
   Writes qa-artifacts-depth-c/candidate-browser-qa.json */
const http = require("http");
const fs = require("fs");
const path = require("path");
const WebSocket = require("ws");
const PUBLIC = process.env.PUBLIC_BASE || "http://127.0.0.1:4178/intelligence/africa";
const CDP_PORT = Number(process.env.CDP_PORT || 9236);
const OUT = path.join(__dirname, "..", "..", "qa-artifacts-depth-c", "candidate-browser-qa.json");
