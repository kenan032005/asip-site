...
# Fix-1C: append only the user-approved manifest bibliographic candidates.
FIX1C_MANIFEST = REPO.parent.parent / "Downloads" / "ASIP_I3B_Fix1B_Correction_Manifest.json"
if FIX1C_MANIFEST.exists():
    _m = json.loads(FIX1C_MANIFEST.read_text(encoding="utf-8"))
    for _sid, _src in _m.get("source_candidates", {}).items():
        NEW_SOURCES.append({
            "source_id": _sid, "title": _src["title"], "publisher": _src["publisher"],
            "source_type": "manifest_candidate", "reliability": "not_independently_rejudged",
            "url": _src["url"], "published_at": _src["published_at"], "accessed_at": REVIEWED,
            "notes": "I3-B-Fix-1C user-approved manifest candidate; no independent research performed."
        })
...
NEW_RELS = [
  ...
  new_rel("rel-endf-ola-conflict", "hostile_to", "actor-endf", "actor-ola",
          "埃塞俄比亚国防军与奥罗莫解放军（OLA）在奥罗米亚交战：主流派拒绝 2024 年 12 月有限和平协议并继续武装行动。公开资料可见不同反政府力量之间存在接触、并行行动或被报道的战术协调，但现有公开证据不足以确认 OLA 与 TPLF 已形成稳定、正式的联盟关系。"),
  new_rel("rel-endf-tdf-conflict", "hostile_to", "actor-endf", "actor-tdf",
          "埃塞俄比亚国防军与提格雷国防军（TDF）2026 年重新对峙：2026 年 1 月特塞莱姆交火、2 月起军事对峙；5 月 TPLF 重建战前地区政府后，提格雷政治安排与联邦支持的过渡机制之间出现严重竞争，联邦政治权威受到重大挑战；《比勒陀利亚协议》正遭受严重压力，但非盟仍将其视为现行和平框架。"),
  ...
  new_rel("rel-burkina-army-jnim", "hostile_to", "actor-burkina-army", "actor-jnim",
          "布基纳法索武装部队与 JNIM 的战争是当前萨赫勒最激烈冲突之一：JNIM 与其他圣战组织在北部、东部及边境地区持续扩大活动并围困部分城镇，2026 年 2 月发动持续一周协同进攻；军队与 VDP 民兵以城镇防御应对。"),
...
REL["rel-mali-army-jnim"] = rel_profile(
  ...
  "主要缺口：双方兵力与控制区无权威数据；FAMa 与俄罗斯非洲军团的协同细节不透明；2026 年 4 月事件后 JNIM—FLA 阶段性协作的持久性存疑。"
)
...
REL["rel-burkina-army-jnim"] = rel_profile(
  ...
  "布基纳法索武装部队与 JNIM 的战争是当前萨赫勒最激烈的对抗之一：JNIM 与其他圣战组织在北部、东部及边境地区持续扩大活动并围困部分城镇（吉博自 2025 年 12 月起），2025 年曾短暂攻占吉博与迪亚帕加，2026 年 2 月发动持续一周协同进攻；军队与 VDP 民兵以城镇防御应对。",
  ...
  "当前状态（截至 2026 年年中）：JNIM 攻势持续、政府军处于守势。瓦加杜古与部分省会被政府军控制，但农村大部的活动与争夺范围缺乏一致、可量化的权威公开评估。",
...
REL["rel-endf-fano-conflict"] = rel_profile(
  ...
  ["解散特别部队引发的武装化", "阿姆哈拉对中央集权的反抗", "提格雷停火后的领土主张争议", "外部支持存在指控但具体对象、方式和规模缺乏充分独立核实"],
...
REL["rel-endf-ola-conflict"] = rel_profile(
  ...
  "埃塞俄比亚国防军与奥罗莫解放军（OLA）在奥罗米亚的交战自 2018 年 OLA 武装化以来持续：2024 年 12 月分裂派签署有限和平协议，但主流派拒绝并继续武装行动。公开资料可见不同反政府力量之间存在接触、并行行动或被报道的战术协调，但现有公开证据不足以确认 OLA 与 TPLF 已形成稳定、正式的联盟关系。",
  ...
  [("2018—2020 年", "武装化", "OLA 在奥罗米亚西部/南部扩张。"),
   ...
   ("2025—2026 年", "主流派持续", "公开资料仅支持不同力量之间可能存在接触或战术协调，不足以确认正式联盟。")],
  ["奥罗米亚政治边缘化与自治诉求", "OLA 内部路线分裂", "不同力量之间可能存在接触或战术协调，但不足以确认正式联盟"],
  [("2024 年 12 月协议", "分裂制度化，主流派孤立但未瓦解。"),
   ("2025—2026 年", "公开资料仅支持不同力量之间可能存在接触或战术协调，不足以确认正式联盟。")],
  "当前状态（截至 2026 年年中）：主流派继续武装抵抗、协议派参与政治进程；OLA 活动对奥罗米亚西部/南部公路与项目构成威胁。公开资料不足以确认 OLA 与 TPLF 已形成稳定、正式联盟。",
...
REL["rel-endf-tdf-conflict"] = rel_profile(
  ...
  "埃塞俄比亚国防军与提格雷国防军（TDF）2026 年重新对峙：2026 年 1 月特塞莱姆交火、梅克莱机场关闭；2 月起军事对峙；5 月 TPLF 重建战前地区政府后，提格雷政治安排与联邦支持的过渡机制之间出现严重竞争，联邦政治权威受到重大挑战；《比勒陀利亚永久停止敌对行动协议》正遭受严重压力，部分关键安排被挑战或未充分落实，但非盟仍将其视为现行和平框架。",  "2020—2022 年提格雷战争以《比勒陀利亚协议》（2022-11）结束，要求 TDF 解除重武器并入联邦体系；整合失败，TDF 保留武装，2025 年提格雷内部政治冲突与 2026 年联邦对峙使局势重新升级。",
  ...
  [("2022 年 11 月", "比勒陀利亚协议", "停火与解除重武器条款未落实。"),
   ...
   ("2026 年 5 月", "TPLF 重建政府", "战前地区政府重建，协议面临严重压力，但非盟仍将其视为现行和平框架。")],
  ["协议落实失败（整编/解除重武器）", "TPLF 的政治自主诉求", "厄立特里亚的介入（被指支持 TPLF）"],
  [("2026 年 1 月交火", "停火后首次直接冲突，局势质变。"),
   ("2026 年 5 月重建政府", "提格雷政治安排与联邦支持的过渡机制竞争加剧，协议承压但框架仍被保留。")],
  "当前状态（截至 2026 年年中）：军事与政治对峙持续，提格雷政治安排与联邦支持的过渡机制竞争加剧；协议部分安排未充分落实，但非盟仍将其视为现行和平框架。",
  "地域差异：西部提格雷（特塞莱姆、拉亚）为对峙前沿；与厄立特里亚边境高度军事化。",
  "提格雷局势是埃塞俄比亚‘联邦 vs 区域力量’最极端案例，其走向影响非洲之角整体稳定（厄立特里亚、苏丹、南苏丹联动）。",
  "TDF—ENDF 关系决定《比勒陀利亚协议》后续安排的可持续性与埃塞俄比亚内战的复发风险。",
...
extend_timeline("rel-endf-tdf-conflict", [
    ...
    tl_item("2026 年 5 月", "TPLF 重建地区政府", "德布雷齐翁领导重建地区政府，提格雷政治安排与联邦支持的过渡机制之间出现严重竞争；协议承受严重压力但仍被非盟视为现行和平框架。", "联邦政治权威受到重大挑战。", "high", sources=("cfr-ethiopia-2026",)),
])
...
# ---- Burkina ----
add("cl-i3b-burkina-jnim-control", "不同来源对布基纳法索领土控制与争夺范围的估计差异显著，不能将争夺区或国家力量无法自由行动区直接等同于 JNIM 单独控制区。",
...
add("cl-i3b-cameroon-vp-2026", "2026 年 4 月，喀麦隆通过宪法修正重新设置副总统职位，由总统任免并承担法定继任功能。截至 2026 年 7 月 22 日，该职位仍未填补；网络流传的任命文件已被事实核查认定为伪造。",
...
add("cl-i3b-ethiopia-tplf-2026", "2026 年 5 月 TPLF 重建战前地区政府，提格雷政治安排与联邦支持的过渡机制之间出现严重竞争；《比勒陀利亚协议》承受严重压力，但非盟仍将其视为现行和平框架；2026 年 2 月起与联邦军事对峙。",
    ["actor-tdf"], [], "cfr-ethiopia-2026", "Global Conflict Tracker, TPLF section", "2026-07-01", "2026-06-30")
add("cl-i3b-ethiopia-ola-2024", "2024 年 12 月 OLA 分裂派与政府签署有限和平协议，主流派指挥层拒绝协议并继续武装行动；公开资料仅支持不同力量之间可能存在接触或战术协调，不足以确认 OLA 与 TPLF 已形成稳定、正式的联盟关系。",
